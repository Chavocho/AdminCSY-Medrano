...
namespace EC_Admin.Forms
{
    public partial class frmProveedor : Form
    {
        ...
        private void BuscarProveedores(string p)
        {
            ...
            try
            {
                string sql = "SELECT id, nombre, razon_social, telefono1, telefono2, email, lada1, lada2 FROM proveedor WHERE nombre LIKE '%" + p + "%' AND eliminado=0 AND id_sucursal='" + Config.idSucursal + "'";
