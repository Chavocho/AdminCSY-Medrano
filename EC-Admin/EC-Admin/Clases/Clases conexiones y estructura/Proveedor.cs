...
namespace EC_Admin
{
    class Proveedor : Persona
    {
        ...
        public override void Insertar()
        {
            ...
            {
                MySqlCommand sql = new MySqlCommand();
                sql.CommandText = "INSERT INTO proveedor (sucursal_id, cuenta_id, nombre, razon_social, rfc, calle, num_ext, num_int, colonia, ciudad, estado, cp, telefono1, telefono2, email, lada1, lada2, tipo, limite_credito, create_user, create_time) " +
        ...
        public override void Editar()
        {
            ...
            {
                MySqlCommand sql = new MySqlCommand();
                sql.CommandText = "UPDATE proveedor SET sucursal_id=?sucursal_id, cuenta_id=?cuenta_id, nombre=?nombre, razon_social=?razon_social, rfc=?rfc, calle=?calle, num_ext=?num_ext, num_int=?num_int, colonia=?colonia, ciudad=?ciudad, " +
